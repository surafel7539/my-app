...
formData.set(
  "agenda",
  JSON.stringify(agenda.split(",").map(agenda => agenda.trim()))
);
  ...
  <form
    ...
    className="rounded-2xl  bg-[#00b972] p-6 shadow-sm sm:p-8"
  >
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 outline-none transition placeholder:text-gray-400 focus:border-black focus:bg-white focus:ring-4 focus:ring-black/5"
              />
            </div>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              rows={6}
              required
              className="w-full resize-none rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 outline-none transition placeholder:text-gray-400 focus:border-black focus:bg-white focus:ring-4 focus:ring-black/5"
            />
          </div>
...
2:00 PM - Panel Discussion`}
      ...
      <div className="border-t border-gray-100 pt-8">
        ...
        >
          {loading
            ? "Creating Event (This might take some time)..."
            : "Create Event"}
        </button>
